...
console.log(formData);
            ...
            toast.error("Échec de l'enregistrement de l'admin");
        }finally {
    ...
    async function Load() {
        try {
            ...
            if (Array.isArray(result.data)) {
                const formateurs = result.data.filter(user => user.type === 'admin');
                setUsers(formateurs);
            } else {
                setUsers([]);
            }
        ...
        try {
         ...
         formData.append('contact', contact);
            ...
            if (err.response && err.response.data) {
                ...
                toast.error('Échec de la mise à jour de l\'admin : ' + err.response.data.message);
            } else {
                toast.error('Erreur inconnue lors de la mise à jour de l\'admin');
            }
        }
    }
    ...
    async function DeleteUser(id) {
        try {
            ...
            toast.error('Échec de la suppression de l\'admin');
        }
    }
...
/>
    ...
    <button onClick={openAddModal} className='btn-create'> <i className="fas fa-plus"></i> Ajouter un admin</button>
